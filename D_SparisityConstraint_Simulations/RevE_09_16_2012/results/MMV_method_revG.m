...
iter.statistical = 2;                       % Number of Statistical Expirements
...
LagrangianHunting.iter = 30;                % Number of regression iterations per step for lagrangian Hunting
...
alpha = 5:0.01:10.9;                         % Sample space used to generate 'a' and likewise A.

% Grid Search Parameters
n = 25:25:100;                                 % Column space of X and y, i.e. number of captured spectra
delta = 10:1:10;                             % Card(x) pattern spacing
SNR = 30:1:30;                              % SNR (dB) of the signal
%AlphaSampleVariety = {'Low','Half','Full'}; % Low Variety, Half Variety, Full Variety
AlphaSampleVariety = {'Low'};
...
% 2 = fLSSP3_revA       --> New LS solver
% 3 = fMLSP_revB        --> New ML solver
solver.type = 2;
                ...
                for iSTATISTICAL=1:iter.statistical
                    ...
                    switch solver.type
                        ...
                        case 2
                            ...
                            [Xsol,~,~,constraint,lagrangian] = fLSSP3_revA(A,y,(1+(5-1).*rand(m,n(iN))),epsilon,LagrangianHunting.numSteps,LagrangianHunting.iter,...
                        ...
                        case 3
                            ...
                            epsilonMLSP = m*n(iN)*Ce+chebParam*sqrt(m*n(iN)*Cv);
                            
                            [Xsol,~,~,constraint,lagrangian] = fMLSP_revB(A,fArowsum,y,(1+(5-1).*rand(m,n(iN))),epsilon,LagrangianHunting.iter,...
