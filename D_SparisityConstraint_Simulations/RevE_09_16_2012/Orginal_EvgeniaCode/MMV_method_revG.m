...
LagrangianHunting.iter = 5000;              % Number of regression iterations per step for lagrangian Hunting
...
alpha = 1:0.1:25;                           % Sample space used to generate 'a' and likewise A.

% Grid Search Parameters
n = 10:10:100;                                 % Column space of X and y, i.e. number of captured spectra
delta = [1,5,10];                             % Card(x) pattern spacing
SNR = 0:10:40;                              % SNR (dB) of the signal
AlphaSampleVariety = [0,0,1];               % 1 = Low Variety, 2 = Half Variety, 3 = Full Variety
