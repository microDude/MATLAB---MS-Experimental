...
% Define Constants
Riter = 10;            % Number of Statistical Expirements
...
for R = 1:Riter
    ...
    b = (1:m);
    alpha = 2 + (60-2).*rand;  % Controls the fatness of the distribution
    ...
    langrangian.niter = 25; % number of iterations to find the langrangian
